...
public class VariableTest1 {
	...
	private static void f7() {
		...
		//&&는 단축구문, 모두 참이면 참이다. 
		//&&는 앞의 결과가 맞으면 뒤에 문장을 수행한다.
		//&&는 앞의 결과가 틀리면 뒤에 문장을 수행하지않는다
	...
	private static void f6() {
		...
		float v2 = 3.12345678901234567890f;//F, f
	...
	private static void f4() {
		//int v1 = 2147483647;  //4byte..4기가저장가능, 가장많이사용
	...
	private static void f1() {
		...
		//변수타입 변수이름
		//변수타입 : data의 성격 (기본형 datatype : 정수, 실수, 논리값)
		//정수 : byte, short, char,  int, long 
		//실수 : float, double 
		//논리 : boolean 
		//나머지는 객체
		
		//1.변수선언(함수내의 있는 변수는 지역변수이다. 지역변수는 반드시 초기화후 사용한다.
